package sg.edu.rp.c346.id21010860.demosimplelistviewexamtips;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        examTipsArray= new ArrayList<>();   //no need verify size
        ...
        ArrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,examTipsArray);//link array list with array adapter
